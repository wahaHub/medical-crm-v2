...
export class DeleteMaterialsPackageUseCase {
  constructor(
  ...
  async execute(hospitalId: string, packageId: string, actor: Actor): Promise<void> {
    ...
    await this.materialsRepo.deletePackage(packageId, hospitalId);
  }
}
