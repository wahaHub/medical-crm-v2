...
export const aiChatSessions = pgTable("ai_chat_sessions", {
	...
	pendingQuestionPayload: jsonb("pending_question_payload").default({}).notNull(),
	lastNextAction: varchar("last_next_action", { length: 50 }),
	lastResolvedIntent: varchar("last_resolved_intent", { length: 80 }),
