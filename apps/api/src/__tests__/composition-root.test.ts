...
vi.mock('@medical-crm/infrastructure/repositories', () => ({
  ...
  DrizzleNotificationRecipientRepository: vi.fn(() => ({})),
  DrizzleEmailNotificationCooldownRepository: vi.fn(() => ({})),
...
vi.mock('@medical-crm/application', () => ({
  ...
  SaveCaseDiagnosisUseCase: vi.fn(() => ({})),
  ...
  SendPatientOnboardingEmailUseCase: vi.fn(() => ({})),
  ...
  GetPatientSessionDetailUseCase: vi.fn(() => ({})),
  SetPasswordUseCase: vi.fn(() => ({})),
  CreateMaterialsPackageUseCase: vi.fn(() => ({})),
  GetMaterialsPackagesUseCase: vi.fn(() => ({})),
  GetMaterialsPackageUseCase: vi.fn(() => ({})),
  UpdateMaterialsPackageUseCase: vi.fn(() => ({})),
  DeleteMaterialsPackageUseCase: vi.fn(() => ({})),
  CreateMaterialsReviewUseCase: vi.fn(() => ({})),
  GetMaterialsReviewsUseCase: vi.fn(() => ({})),
  UpdateMaterialsReviewUseCase: vi.fn(() => ({})),
  DeleteMaterialsReviewUseCase: vi.fn(() => ({})),
  // Chatbot FAQ
  ...
  ListAdminEmailsUseCase: vi.fn(() => ({})),
  UpdateProfileUseCase: vi.fn(() => ({})),
  ChangePasswordUseCase: vi.fn(() => ({})),
  NotificationEmailService: vi.fn(() => ({})),
  ...
  ResumeConversationAiUseCase: vi.fn(() => ({})),
}));
