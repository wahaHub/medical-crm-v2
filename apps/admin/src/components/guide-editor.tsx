...
export function GuideEditor({ guideId }: { guideId?: string }) {
  ...
  async function uploadHeroImage(file: File | undefined) {
    ...
    try {
      ...
      setHeroUploadProgress(8);
      await uploadFileWithProgress(init.upload.uploadUrl, file, setHeroUploadProgress);
    ...
    finally { setIsUploadingImage(false); setHeroUploadProgress(null); }
  }
