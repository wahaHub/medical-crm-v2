...
export function getServices(): AppServices {
  if (!_services) {
    ...
    _services = {
      ...
      listCaseConsultations: new ListCaseConsultationsUseCase(consultationRepo, caseRepo, chcRepo),

      recordCaseEvent: new RecordCaseEventUseCase(eventRepo),
      listCaseEvents: new ListCaseEventsUseCase(eventRepo, caseRepo, chcRepo),
      getCaseTimeline: new GetCaseTimelineUseCase(eventRepo, journeyRepo, caseRepo, chcRepo),

      addHospitalToCase: new AddHospitalToCaseUseCase(chcRepo, caseRepo, hospitalRepo, userRepo),
      ...
      getCaseJourney: new GetCaseJourneyUseCase(journeyRepo, caseRepo, chcRepo),
      updateCaseJourney: new UpdateCaseJourneyUseCase(journeyRepo, caseRepo),
      listMilestones: new ListMilestonesUseCase(journeyRepo, caseRepo, chcRepo),
      ...
      getQCResponse: new GetQCResponseUseCase(qcRepo, caseRepo, chcRepo),
