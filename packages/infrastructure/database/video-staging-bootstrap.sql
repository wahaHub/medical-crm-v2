...
CREATE TABLE IF NOT EXISTS video_consultation_interpretation_jobs (
  ...
  source_language text NOT NULL CHECK (source_language IN ('zh', 'en', 'es', 'pt', 'fr', 'de', 'it', 'ru', 'ja', 'ko', 'hi', 'id', 'vi')),
  target_language text NOT NULL CHECK (target_language IN ('zh', 'en', 'es', 'pt', 'fr', 'de', 'it', 'ru', 'ja', 'ko', 'hi', 'id', 'vi') AND target_language <> source_language),
...
CREATE TABLE IF NOT EXISTS video_consultation_source_tracks (
  ...
  expected_source_language text NOT NULL CHECK (expected_source_language IN ('zh', 'en', 'es', 'pt', 'fr', 'de', 'it', 'ru', 'ja', 'ko', 'hi', 'id', 'vi')),
  target_language text NOT NULL CHECK (target_language IN ('zh', 'en', 'es', 'pt', 'fr', 'de', 'it', 'ru', 'ja', 'ko', 'hi', 'id', 'vi') AND target_language <> expected_source_language),
